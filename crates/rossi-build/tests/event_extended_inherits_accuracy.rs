...
const IDENTITY_M0: &str = r#"<?xml version="1.0" encoding="UTF-8"?>
...
const IDENTITY_M1: &str = r#"<?xml version="1.0" encoding="UTF-8"?>
<org.eventb.core.machineFile org.eventb.core.configuration="org.eventb.core.fwd" version="5">
...
fn inherited_labels_keep_unique_names_and_resolvable_targets() {
    let project = Project::new(
        "p/q",
        vec![
            ProjectComponent::from_xml("M0.bum", IDENTITY_M0).unwrap(),
            ProjectComponent::from_xml("M1.bum", IDENTITY_M1).unwrap(),
        ],
    );
